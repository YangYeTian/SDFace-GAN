...
class BoundingBoxGenerator(nn.Module):
    ...
    Args:
        n_boxes (int): number of bounding boxes (excluding background)  边界框数，不包括背景
    ...
    def __init__(self, n_boxes=1,
        ...
        self.check_collison = check_collison  # 是否检测冲突
        self.collision_padding = collision_padding  # 冲突检测填充
